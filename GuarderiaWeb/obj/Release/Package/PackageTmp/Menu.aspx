<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="GuarderiaWeb.Menu" %>
    ...
    <div class="row ">
        <div class="col-12 text-left">
            <div class="col-form-label  pl-3 text-capitalize">
                ...
                <label runat="server">Administrar Menu</label>
                <%--Nombre de la pagina--%>
            </div>
        </div>
    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="staticBackdropLabel">Adminsitrar Menu</h5>
                        <%-- Titulo del modal--%>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        <asp:Label ID="lbl" runat="server" Text="Precio" CssClass="" ToolTip="Nombre completo de la persona" Width="100px"></asp:Label>
                                        <asp:TextBox ID="txtPrecio" runat="server" ReadOnly="false" CssClass="form-control ml-4" TextMode="Number"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 d-flex mt-3 justify-content-center ">
                                    ...
                                    <asp:Button ID="btnSempleadoAgregar" runat="server" Text="Platos" CssClass="btn btn-primary" OnClick="btnSempleadoAgregar_Click" /><%--   Nombre del botom--%>
                                </div>
                            </div>
                        </div>
                    </div>
