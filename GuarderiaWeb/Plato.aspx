<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Plato.aspx.cs" Inherits="GuarderiaWeb.Plato" %>
    ...
    <div class="row ">
        <div class="col-12 text-left">
            <div class="col-form-label  pl-3 text-capitalize">
                ...
                <label runat="server">Administrar Platos</label>
                <%--Nombre de la pagina--%>
            </div>
        </div>
    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="staticBackdropLabel">Adminsitrar Platos</h5>
                        <%-- Titulo del modal--%>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex mt-3 justify-content-center ">
                                    ...
                                    <asp:Button ID="btnSempleadoAgregar" runat="server" Text=" Administrar Ingrediente" CssClass="btn btn-primary" OnClick="btnSempleadoAgregar_Click" /><%--   Nombre del botom--%>
                                </div>
                            </div>
                        </div>
                    </div>
