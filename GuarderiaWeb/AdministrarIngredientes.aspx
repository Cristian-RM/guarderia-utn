<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdministrarIngredientes.aspx.cs" Inherits="GuarderiaWeb.Ingredientes_de_plato" %>
    ...
    <div class="row ">
        <div class="col-12 text-left">
            <div class="col-form-label  pl-3 text-capitalize">
                ...
                <label runat="server">Administrar Ingredienes de plato</label>
                <asp:Label ID="lblPlato" runat="server" Text="Label"></asp:Label>
                <%--Nombre de la pagina--%>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3 ">
        <div class="col-12 " style="left: 0px; top: 0px">
            <div class="col-form-label">
                <h4>Lista de Ingredientes de Plato</h4>
                <%-- Listar objetos--%>
            </div>
        </div>
        ...
        <div class="col-12 mt-2 w-100">
            <div id="AlertFooter" class="alert alert-dark" role="alert" runat="server" visible="false">
                <div class="form-check-label  h-100 w-100 ">
                    ...
                    <asp:Label ID="informacion" runat="server" Text="" CssClass="text-light"></asp:Label>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="staticBackdropLabel">Adminsitrar Ingrediente del plato</h5>
                        <%-- Titulo del modal--%>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        <asp:Label ID="lblID" runat="server" Text="ID" CssClass="" ToolTip="Nombre completo de la persona" Width="100px"></asp:Label>
                                ...
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        <asp:Label ID="lblNombrePlato" runat="server" Text="NOMBRE" CssClass="" ToolTip="Nombre completo de la persona" Width="100px"></asp:Label>
                                        <asp:TextBox ID="txtNombrePlato" runat="server" ReadOnly="false" CssClass="form-control ml-4"></asp:TextBox>
                                    </div>
                                </div>
                                <%--  NOMBRE DE LA ingrediente--%>
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        <asp:Label ID="lblNombreIngrediente" runat="server" Text="NOMBRE" CssClass="" ToolTip="Nombre completo de la persona" Width="100px"></asp:Label>
                                        <asp:DropDownList ID="txtNombreIngrediente" runat="server" ReadOnly="false" CssClass="form-control ml-4"></asp:DropDownList>
                                    </div>
                                </div>
