...
{
    public partial class PlatosDEmenu : System.Web.UI.Page
    {
        ...
        private String validarSessino()
        {
            try
            {
                String plato = (String)Session["menu"];
                int platoID = Convert.ToInt32(plato);
                lblMenu.Text = (string)Session["menuNombre"];
        ...
        public void cargarIngredientes()
        {
            ...
            try
            {
                ...
                DataTable result = Ws.crudPlatos("", "l")[0];
        ...
        {
            GuarderiaWeb.ServiceReference1.ServicioGuarderiaSoapClient Ws = new ServiceReference1.ServicioGuarderiaSoapClient();
            DataTable[] result = Ws.crudPlatosMenu(parse(txtID.Text), txtNombreIngrediente.SelectedValue, parse(txtMenuID.Text), op);
