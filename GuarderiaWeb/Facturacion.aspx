<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Facturacion.aspx.cs" Inherits="GuarderiaWeb.Facturacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row ">
        ...
        <div class="col-12 text-left">
            <div class="col-form-label  pl-3 text-capitalize">
                ...
                <label runat="server">Administrar Facturas  </label>
    ...
    <div class="row mb-3 ">
        ...
        <div class="col-12 justify-content-center align-items-center border w-100  mt-3" style="width: 100%; height: 500px; overflow: scroll">
        ...
        <div class="col-12 justify-content-center align-items-center border w-100 mt-3 " style="width: 100%; height:500px; overflow: scroll">
            ...
            <%-- cambiar nombre de la tabla--%>
            <asp:GridView ID="tblAsistencias" runat="server" CssClass="table table-hover table-responsive-sm " AutoGenerateSelectButton="false" Width="100%" EnablePersistedSelection="false" OnSelectedIndexChanged="tblEmpresas_SelectedIndexChanged">
                <EditRowStyle CssClass="bg-warning" ForeColor="White" />
                <EmptyDataRowStyle BorderStyle="Dotted" />
                <SelectedRowStyle CssClass="bg-success" />
            </asp:GridView>
        ...
        <div class="col-12 justify-content-center align-items-center border w-100 mt-3" style="width: 100%; height: 500px; overflow: scroll">
            <h4>Lista de Consumos</h4>
            <%-- cambiar nombre de la tabla--%>
            <asp:GridView ID="tblConsumos" runat="server" CssClass="table table-hover table-responsive-sm " AutoGenerateSelectButton="false" Width="100%" EnablePersistedSelection="false" OnSelectedIndexChanged="tblEmpresas_SelectedIndexChanged">
                <EditRowStyle CssClass="bg-warning" ForeColor="White" />
                <EmptyDataRowStyle BorderStyle="Dotted" />
                <SelectedRowStyle CssClass="bg-success" />
            </asp:GridView>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="staticBackdropLabel">Administrar Facturas</h5>
                        <%-- Titulo del modal--%>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        <asp:Label ID="lblIngrediente" runat="server" Text="ID Abonado" CssClass="" ToolTip="" Width="100px"></asp:Label>
