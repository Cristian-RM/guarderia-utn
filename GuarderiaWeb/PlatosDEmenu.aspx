<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PlatosDEmenu.aspx.cs" Inherits="GuarderiaWeb.PlatosDEmenu" %>
    ...
    <div class="row ">
        <div class="col-12 text-left">
            <div class="col-form-label  pl-3 text-capitalize">
                ...
                <label runat="server">Administrar Platos del Menu de </label>
    ...
    <div class="row mb-3 ">
        <div class="col-12 " style="left: 0px; top: 0px">
            <div class="col-form-label">
                <h4>Lista de Platos de Plato</h4>
                <%-- Listar objetos--%>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="staticBackdropLabel">Adminsitrar Platos del menu</h5>
                        <%-- Titulo del modal--%>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        ...
                                        <asp:TextBox ID="txtMenuID" runat="server" ReadOnly="false" CssClass="form-control ml-4"></asp:TextBox>
                                    </div>
                                </div>
                                <%--  NOMBRE DE LA ingrediente--%>
                                <div class="col-12 d-flex flex-column mt-3">
                                    <div class="d-flex">
                                        <asp:Label ID="lblNombreIngrediente" runat="server" Text="Platos" CssClass="" ToolTip="Nombre completo de la persona" Width="100px"></asp:Label>
